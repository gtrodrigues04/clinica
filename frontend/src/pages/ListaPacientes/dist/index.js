...
exports.ListaPacientes = function () {
        ...
        function loadLista() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, axios_1["default"].get(request_1.BASE_URL + "/pacientes")];
                        case 1:
                            res = _a.sent();
    ...
    return (React.createElement("div", { className: "jumbotron" },
        React.createElement("div", { className: 'card-paciente' }, pacientes.map(function (item) {
            return (React.createElement("article", { key: item.id },
                ...
                React.createElement("div", { className: 'Button' },
                    React.createElement(react_router_dom_1.Link, { to: "/edit/" + item.id },
                        React.createElement("button", null, "Editar")),
                    React.createElement("button", { onClick: function () { axios_1["default"]["delete"](request_1.BASE_URL + "/pacientes/" + item.id); window.location.reload(); } }, "Excluir"))));
        }))));
};
